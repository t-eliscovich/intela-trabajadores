...
check("la vista por día lista cuántos comieron cada día", "Cuántos comieron cada día" in html and "Martes 6 de enero" in html and "Total del mes" in html)
check("y la vista por persona sigue siendo el cuadro", "Por persona" in html and 'class="cuadro"' in c.get("/admin/comidas?mes=2026-01&vista=cuadro").get_data(as_text=True))
