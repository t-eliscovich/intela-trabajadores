...
r = k.post(T + "/confirmar", data={"cedula": "1712345678", "tipo": TIPO})
html = r.get_data(as_text=True)
check("con Sí queda marcado, por la tablet", (juan, HOY, TIPO) in base.alm and "Buen provecho" in html)
check("y ofrece invitados y deshacer", "¿Trae invitados?" in html and "deshacer" in html)
