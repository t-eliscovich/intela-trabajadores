...
check("el que no cumplió el año lee cuándo lo cumple y que se suman 15 de una", "todavía no cumplís un año" in html and (HOY - timedelta(days=100)).replace(year=HOY.year + 1).strftime("%d/%m/%Y") in html and "15</b> días de vacaciones de una" in html)
r = c.get("/yo/perfil")
