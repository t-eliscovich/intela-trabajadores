...
check("turnos: antes de las 12 el primero, 12:40 el segundo, 15:00 el último", A.nombre_turno("13:30") == "13:30 a 14:00" and A.nombre_turno(None) == "" and A.leer_turno("12:30", "almuerzo") == "12:30" and A.leer_turno("12:30", "cena") is None and A.leer_turno("", "almuerzo") == A.turno_de_ahora())
...
check("anota 2 invitados con descripción, con su mismo horario", "2 invitados anotados" in r.get_data(as_text=True) and sum(i["cantidad"] for i in base.invitados_del_dia(HOY)) == 2
      and base.invitados_del_dia(HOY)[0]["turno"] == ("12:30" if TIPO == "almuerzo" else None))
...
check("ve quién comió hoy, los invitados bajo su horario y quiénes faltan", "Juan Pérez" in html and "+2</b> proveedor" in html and "No se anotaron" in html and "María López" in html and "Sin horario" not in html)
